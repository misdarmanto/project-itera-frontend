...
function UserPopUp({ children }: any) {
  return (
          ...
          <div className="w-full max-w-sm p-5 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div className="flex flex-col items-center pb-10">
              <img
                ...
                alt="Bonnie image"
              />
              <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Misdar</h5>
              <span className="text-sm text-gray-500 dark:text-gray-400">misdar@itera.edu</span>
